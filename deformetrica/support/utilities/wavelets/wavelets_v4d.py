...
def haar_FWT_renorm_shape(shape, J = None):
    ...
    #print("np.sqrt(np.sum(FWT * FWT, axis=1))", np.sqrt(np.sum(FWT * FWT, axis=1)))
...
#print("haar", haar)
#print("haar.haar_backward()", haar.haar_backward())
haar._haar_coeff_scale_1D(0, haar.ws[0])
#print()
# %%
haar = haar_backward_transpose(S, J=2, gamma=1)
#print("haar_backward_transpose(S, J=2, gamma=1", haar)
#print("haar.haar_backward()", haar.haar_backward())
